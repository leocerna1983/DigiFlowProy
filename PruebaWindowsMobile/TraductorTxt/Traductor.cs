...
namespace TraductorTxt
{
    public class Traductor
    {
        ...
        public Traductor(string File, int CompaniaId)
        {
            ...
            file = Path.GetDirectoryName(Assembly.GetExecutingAssembly().GetName().CodeBase) + "\\" + File;
        }
        ...
        public byte[] Procesar(byte[] bytes, int pDocumentoId)
        {
            ...
            if (documentoId > 0)
            {
                ...
                {
                    string cadena = System.Text.Encoding.UTF8.GetString(bytes, 0, bytes.Length);
        ...
        /// <summary>
        /// Sobre carga con documentid por defecto = 1
        /// </summary>
